...
public class Ejemplo062 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arreglo1.length; i++) {
            ...
            if ((dato >= 5 && dato <= 9) || (dato == 11 || dato == 13 || dato
                    == 14)) {
                /*
                se crea la condicion para poder generar las restricciones
                de la tabla
                 */

            } else { //el else va para que cuando no se cumpla la condicion

                dato = 5;
                //se cambie automaticamente el valor a 5
            }
